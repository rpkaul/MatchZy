        ...
        public void OnStopCommand(CCSPlayerController? player, CommandInfo? command)
        {
            ...
            if (isStopCommandAvailable && isMatchLive)
            {
                ...
                else
                {
                    ...
                    // PrintToPlayerChat($"{chatPrefix} {ChatColors.Green}{stopTeamName}{ChatColors.Default} wants to restore the game to the beginning of the current round. {ChatColors.Green}{remainingStopTeam}{ChatColors.Default}, please write !stop to confirm.");
                }
            }
        }
