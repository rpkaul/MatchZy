...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        private void StartLive() {
            ...
            PrintToAllChat($"{chatPrefix} {ChatColors.Red}Plugin Version {ChatColors.Green}MatchZy v0.7.11 by -WD");
            PrintToAllChat($"{chatPrefix} {ChatColors.Red}Commands {ChatColors.Green}!pause or !tac, !tech, !stop. Overtime enabled.");
            PrintToAllChat($"{chatPrefix} {ChatColors.Red}Custom agent skins are prohibited. However, teams will not be disqualified. If players have an issue with that, they can ask the opponents to remove it.");
